<template>
 ...
 <div>
    ...
    <main class="wrapper ai-window">
        ...
        <br>
        <p class="copyright" v-if="answers.length > 0 && config.app.watermark">Proudly powered by  Smart Groupe </a></p>
        <a id="bottom"></a>
    </main>
        ...
        <div class="wrapper" v-if="micro == false">
            <i class="material-icons iicon fa fa-microphone" @click="microphone(true)"> </i>
            ...
            <i class="material-icons iicon t2s fa fa-volume-up" @click="mute(true)" v-if="muted == false"></i>
            <i class="material-icons iicon t2s fa fa-volume-down" @click="mute(false)" v-else></i>
        </div>
        <div class="wrapper" v-else>
            <i class="material-icons iicon recording fa fa-microphone " @click="microphone(false)"></i><input class="queryform" :placeholder="speech" readonly>   
        </div>
    </div>  
